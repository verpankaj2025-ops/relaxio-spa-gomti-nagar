...
const footerLinks = [
  ...
  { href: "/services/balinese-massage", label: "Balinese Massage in Gomti Nagar Lucknow" },
  {
    href: "/services/deep-tissue-massage",
    label: "Deep Tissue Massage in Gomti Nagar Lucknow",
  },
  {
    href: "/services/couple-massage",
    label: "Couple Massage in Gomti Nagar Lucknow",
  },
  {
    href: "/services/spa-facilities",
    label: "Jacuzzi & Steam Bath in Gomti Nagar Lucknow",
  },
...
const locationLinks = [
  { href: "/spa-in-aliganj-lucknow", label: "Spa in Aliganj Lucknow" },
  { href: "/spa-in-hazratganj-lucknow", label: "Spa in Hazratganj Lucknow" },
  { href: "/spa-in-indira-nagar-lucknow", label: "Spa in Indira Nagar Lucknow" },
  { href: "/spa-in-chinhat-lucknow", label: "Spa in Chinhat Lucknow" },
  { href: "/spa-in-mahanagar-lucknow", label: "Spa in Mahanagar Lucknow" },
  {
    href: "/spa-in-gomti-nagar-extension-lucknow",
    label: "Spa in Gomti Nagar Extension Lucknow",
  },
  {
    href: "/spa-near-faizabad-road-lucknow",
    label: "Spa Near Faizabad Road Lucknow",
  },
];
...
const seoLinks = [
  {
    ...
    label: "Best Spa in Gomti Nagar Lucknow",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          ...
          <p className="mb-6 font-light leading-relaxed max-w-sm text-stone-300">
            Relaxio Spa offers peaceful wellness experiences with private rooms,
            relaxing therapies, and a calm luxury ambience in Gomti Nagar
            Lucknow.
          </p>
        </div>

        <div>
          <h4 className="text-white text-lg font-serif mb-5 tracking-wide">
            Spa Services
          </h4>
        ...
        <div>
          <h4 className="text-white text-lg font-serif mb-6 tracking-wide">
            Visit Us
          </h4>

          <address
            className="not-italic space-y-4 font-light"
            itemScope
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              ...
              <nav
                ...
                aria-label="Popular spa areas in Lucknow"
              >
          ...
          <div className="mt-10 pt-6 border-t border-stone-900 flex flex-col md:flex-row justify-between items-center gap-4 text-sm font-light">
            ...
            <a
              ...
              aria-label="Chat with Relaxio Spa on WhatsApp"
